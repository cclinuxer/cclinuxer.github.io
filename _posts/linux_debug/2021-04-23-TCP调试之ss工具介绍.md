...
​		这篇文章的内容没有太多的新意，只是我首次使用他的时候，被他的功能给惊艳到了，他可以查看tcp套接字的定时器，套接字状态，发送接收窗口， MSS等即使我们在没有抓到包的情况下，也能快速的去依靠他分析一些线上问题。所以把他的[man page](https://man7.org/linux/man-pages/man8/ss.8.html)搬到我的博客，自己翻文章的时候看一下。如下图，它提供的东西太多了，具体使用方式，以及参数含义，请查看man page的内容，我就不翻译了。

​		![image-20210423190350786](https://gitee.com/cclinuxer/blog_image/raw/master/image/image-20210423190350786.png)

```
SS(8)                    System Manager's Manual                   SS(8)
```

## NAME     [top](https://man7.org/linux/man-pages/man8/ss.8.html#top_of_page)

```
       ss - another utility to investigate sockets
```

## SYNOPSIS     [top](https://man7.org/linux/man-pages/man8/ss.8.html#top_of_page)

```
       ss [options] [ FILTER ]
```

## DESCRIPTION     [top](https://man7.org/linux/man-pages/man8/ss.8.html#top_of_page)
...
## OPTIONS     [top](https://man7.org/linux/man-pages/man8/ss.8.html#top_of_page)
...
## STATE-FILTER     [top](https://man7.org/linux/man-pages/man8/ss.8.html#top_of_page)
...
## EXPRESSION     [top](https://man7.org/linux/man-pages/man8/ss.8.html#top_of_page)
...
## HOST SYNTAX     [top](https://man7.org/linux/man-pages/man8/ss.8.html#top_of_page)
...
## USAGE EXAMPLES     [top](https://man7.org/linux/man-pages/man8/ss.8.html#top_of_page)
...
## SEE ALSO     [top](https://man7.org/linux/man-pages/man8/ss.8.html#top_of_page)
...
## AUTHOR     [top](https://man7.org/linux/man-pages/man8/ss.8.html#top_of_page)
...
## COLOPHON     [top](https://man7.org/linux/man-pages/man8/ss.8.html#top_of_page)
